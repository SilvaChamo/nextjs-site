...
import { Handshake, TrendingUp, ArrowRight, Eye, Globe, Target, Briefcase } from "lucide-react";
    ...
    return (
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-[1350px] mx-auto px-4 md:px-[60px] relative z-20 mt-[50px] pb-24">
                ...
                {/* 3. Quem procuramos */}
                <div className="bg-white rounded-3xl p-10 md:p-16 mb-16 border border-slate-200">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-xl relative text-center border border-slate-100">
                                ...
                                <form id="parceria-form" className="space-y-4 text-left" action="mailto:geral@baseagrodata.com" method="POST" encType="text/plain">
                                    <div>
                                        ...
                                        <input type="text" name="empresa" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-medium text-slate-700" placeholder="Ex: AgroTech Lda" required />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Email Corporativo</label>
                                        <input type="email" name="email" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-medium text-slate-700" placeholder="contacto@empresa.com" required />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Mensagem Curta</label>
                                        <textarea name="mensagem" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-medium h-24 resize-none text-slate-700" placeholder="Descreva brevemente seu interesse..." required></textarea>
                                    </div>
                ...
                {/* 1. Crescemos Juntos - Image Left / Text Right */}
                <section className="bg-transparent py-10 md:pt-[20px] md:pb-[80px] overflow-hidden">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
                        {/* Left Column: Image (Replaces Cards) */}

                                            ...
                                            <div className={cn(
                                                ...
                                                <div className={cn(
                                                    ...
                                                    <div className="prose prose-invert max-w-none 
                                                        ...
                                                        prose-li:text-slate-300 prose-li:marker:text-orange-500
                                                        prose-blockquote:border-l-4 prose-blockquote:border-orange-500 prose-blockquote:pl-6 prose-blockquote:italic
                                                        [&_img.content-image]:inline-block [&_img.content-image]:w-full lg:[&_img.content-image]:w-[48%] [&_img.content-image]:h-auto lg:[&_img.content-image]:max-h-[500px] [&_img.content-image]:object-contain [&_img.content-image]:m-[1%] [&_img.content-image]:rounded-xl [&_img.content-image]:shadow-lg [&_img.content-image]:vertical-align-top
                                                        [&_img[style*='width: 100%']]:w-full [&_img[style*='width: 100%']]:block [&_img[style*='width: 100%']]:m-[20px_0] [&_img[style*='width: 100%']]:object-contain"
                                                        dangerouslySetInnerHTML={{ __html: slide.content }}>
                                                    </div>

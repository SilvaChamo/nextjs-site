                                    ...
                                    <div className="flex flex-col h-full">
                                        ...
                                        <div className="flex-1 flex flex-col min-h-0 justify-end">
                                            ...
                                            <div className="bg-[#f9fafb] rounded-[10px] p-4 space-y-2 flex flex-col shadow-inner border border-gray-100">
                                                ...
                                                />
                                                <Button className="w-full rounded-[10px] bg-slate-900 text-white hover:bg-[#f97316] transition-all font-bold h-8 text-[10px] shadow-sm self-start uppercase tracking-wider">
                                                    Enviar
                                                </Button>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex-1 flex flex-col min-h-0 gap-4 mt-2">
                                            ...
                                            <div className="shrink-0">
                                                <div className="flex items-center gap-2 mb-1.5 shrink-0">
                                                    ...
                                                    <h3 className="text-gray-600 text-[11px] font-bold uppercase tracking-wider">Entrar</h3>
                                                </div>
                                                <div className="bg-[#f9fafb] rounded-[10px] p-3 space-y-2 shadow-inner border border-gray-100">
                                                    <Input placeholder="E-mail" className="rounded-[10px] bg-white border-none h-8 px-3 text-xs shadow-sm" />
                                                    <Input type="password" placeholder="Senha" className="rounded-[10px] bg-white border-none h-8 px-3 text-xs shadow-sm" />
                                                    <Button className="w-full rounded-[10px] h-8 bg-slate-900 text-white hover:bg-[#f97316] font-bold text-[10px] uppercase tracking-widest transition-all shadow-sm">Entrar</Button>
                                                </div>
                                            </div>
                                            ...
                                            <div className="shrink-0">
                                                <div className="flex items-center gap-2 mb-1.5 shrink-0">
                                                    <div className="w-0.5 h-3 bg-[#f97316]"></div>
                                                    <h3 className="text-gray-600 text-[11px] font-bold uppercase tracking-wider">Registar</h3>
                                                </div>
                                                <div className="bg-[#f9fafb] rounded-[10px] p-3 space-y-2 shadow-inner border border-gray-100">
                                                    <Input placeholder="Nome" className="rounded-[10px] bg-white border-none h-8 px-3 text-xs shadow-sm" />
                                                    <Input placeholder="E-mail" className="rounded-[10px] bg-white border-none h-8 px-3 text-xs shadow-sm" />
                                                    <Input type="password" placeholder="Senha" className="rounded-[10px] bg-white border-none h-8 px-3 text-xs shadow-sm" />
                                                    <Button className="w-full rounded-[10px] h-8 bg-slate-900 text-white hover:bg-[#f97316] font-bold text-[10px] uppercase tracking-widest transition-all shadow-sm">Registar</Button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

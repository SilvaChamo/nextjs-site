            ...
            <div className="relative z-10 container-site grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full pt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 animate-in slide-in-from-right-6 duration-700 delay-200">
                    ...
                    <Link href="/estatisticas/empresas" className="block h-full animate-float">
                        <div className="bg-gradient-to-br from-white/20 to-white/5 border border-[#f97316] p-5 rounded-[10px] shadow-2xl hover:from-white/30 hover:to-white/10 hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:scale-105 transition-all duration-300 group relative overflow-hidden h-full cursor-pointer">
                            <div className="absolute top-0 right-0 p-2 opacity-50">
                                <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                            </div>
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-white mb-2 truncate drop-shadow-md" suppressHydrationWarning>Empresas Agrárias</h4>
                            <h3 className="text-4xl font-heading font-black text-white mb-1 drop-shadow-md" suppressHydrationWarning><span>{getVal('hero-companies', '950+')}</span></h3>
                    ...
                    <Link href="/estatisticas/producao" className="block h-full animate-float-delayed">
                        <div className="bg-gradient-to-br from-white/20 to-white/5 border border-white/40 p-5 rounded-[10px] shadow-2xl hover:from-white/30 hover:to-white/10 hover:border-[#f97316] hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:scale-105 transition-all duration-300 group relative h-full cursor-pointer">
                    ...
                    <Link href="/estatisticas/economia" className="block h-full md:col-span-2 lg:col-span-1 animate-float">
                        <div className="bg-gradient-to-br from-white/20 to-white/5 border border-white/40 p-5 rounded-[10px] shadow-2xl hover:from-white/30 hover:to-white/10 hover:border-[#f97316] hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:scale-105 transition-all duration-300 group relative h-full cursor-pointer">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-right text-gray-200 mt-1" suppressHydrationWarning><span>{getTrend('hero-economy', '24% do PIB Nacional')}</span></p>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link href="/estatisticas/emprego" className="block h-full md:col-span-2 lg:col-span-1 animate-float-delayed">
                        <div className="bg-gradient-to-br from-white/20 to-white/5 border border-white/40 p-5 rounded-[10px] shadow-2xl hover:from-white/30 hover:to-white/10 hover:border-[#f97316] hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:scale-105 transition-all duration-300 group md:col-span-2 lg:col-span-1 h-full cursor-pointer">

                                        ...
                                        <div className="w-full grid grid-cols-1 lg:grid-cols-[550px_1fr] gap-[35px] items-start flex-1">
                                            ...
                                            <div className="flex flex-col items-center lg:items-start w-full">
                                                <div className="relative group w-full max-w-[550px]">
                                                    ...
                                                    {slide.image_url ? (
                                                        <div className="relative w-full aspect-video rounded-[20px] overflow-hidden border border-white/10 shadow-2xl bg-slate-900">
                                                        ...
                                                        <div className="relative w-full aspect-video rounded-[20px] bg-white/5 border border-dashed border-white/10 flex items-center justify-center">
